...
ARCHETYPES = {
    ...
    "elite": {
        "name": "Elite Force",
        "description": "Small, highly-trained professional units with special operations focus",
    ...
    # === SPACE-FOCUSED DOCTRINES ===
    "swarm": {
        "name": "Swarm Doctrine",
        "description": "Overwhelming numbers with drone swarms and orbital saturation",
    ...
    "void_fleet": {
        "name": "Void Fleet",
        "description": "Deep-space carrier battlegroups with fighter screen superiority",
        "stat_weights": {"exosphere": 0.6, "naval": 0.2, "military": 0.2},
        "preferred_main_actions": ["attack", "super_unit"],
        "preferred_minor_actions": ["prepare_attack", "prepare_super_unit"],
        "aggression": 0.7,
    },
    "orbital_supremacy": {
        ...
        "description": "Space-based weapons platforms and kinetic bombardment specialists",
        "stat_weights": {"exosphere": 0.7, "naval": 0.1, "military": 0.2},
        "preferred_main_actions": ["attack", "super_unit"],
        "preferred_minor_actions": ["prepare_attack", "sabotage"],
        "aggression": 0.65,
    },

    # === NAVAL-FOCUSED DOCTRINES ===
    "armada": {
        "name": "Grand Armada",
        "description": "Massive naval battlefleets with carrier strike groups and submarine warfare",
        "stat_weights": {"exosphere": 0.15, "naval": 0.7, "military": 0.15},
        "preferred_main_actions": ["attack", "super_unit"],
        "preferred_minor_actions": ["prepare_attack", "fortify_defense"],
        "aggression": 0.6,
    },
    "thalassocracy": {
        "name": "Thalassocracy",
        "description": "Naval empire with ocean control, amphibious assault capabilities",
        "stat_weights": {"exosphere": 0.2, "naval": 0.6, "military": 0.2},
        "preferred_main_actions": ["attack", "defend"],
        "preferred_minor_actions": ["prepare_attack", "heal"],
        "aggression": 0.55,
    },
    "leviathan_corps": {
        "name": "Leviathan Corps",
        "description": "Deep-sea titan creatures and bio-engineered naval beasts",
        "stat_weights": {"exosphere": 0.1, "naval": 0.65, "military": 0.25},
        "preferred_main_actions": ["attack"],
        "preferred_minor_actions": ["sabotage", "heal"],
        "aggression": 0.75,
    },

    # === GROUND-FOCUSED DOCTRINES ===
    "guerrilla": {
        "name": "Guerrilla Force",
        "description": "Asymmetric warfare specialists with hit-and-run tactics",
    ...
    "insurgent": {
        ...
        "description": "Rebellion and terrorism specialists with unpredictable hit-and-fade tactics",
    ...
    "defensive_bloc": {
        "name": "Defensive Bloc",
        "description": "Fortification-focused with attrition warfare and prepared positions",
    ...
    # === ELDRITCH/ABERRANT DOCTRINES ===
    "void_cult": {
        "name": "Void Cult",
        "description": "Reality-warping cultists channeling dark-matter entities from beyond",
        "stat_weights": {"exosphere": 0.4, "naval": 0.1, "military": 0.5},
        "preferred_main_actions": ["attack", "super_unit"],
        "preferred_minor_actions": ["sabotage", "prepare_super_unit"],
        "aggression": 0.7,
    },
    "eldritch_hive": {
        "name": "Eldritch Hive",
        "description": "Biomechanical swarm intelligence with incomprehensible tactics",
        "stat_weights": {"exosphere": 0.3, "naval": 0.2, "military": 0.5},
        "preferred_main_actions": ["attack"],
        "preferred_minor_actions": ["sabotage", "heal"],
        "aggression": 0.85,
    ...
    "nightmare_legion": {
        ...
        "description": "Reality-bending horrors that defy conventional military doctrine",
        "stat_weights": {"exosphere": 0.25, "naval": 0.25, "military": 0.5},
        "preferred_main_actions": ["attack", "super_unit"],
        "preferred_minor_actions": ["sabotage", "prepare_attack"],
        "aggression": 0.8,
    },
    "old_ones": {
        "name": "Old Ones",
        "description": "Lovecraftian cosmic horrors - non-Euclidean geometry, maddening presence, incomprehensible to mortal minds",
        "stat_weights": {"exosphere": 0.35, "naval": 0.35, "military": 0.3},
        "preferred_main_actions": ["super_unit", "attack"],
        "preferred_minor_actions": ["sabotage", "prepare_super_unit"],
        "aggression": 0.5,
    },
    "infernal_legions": {
        "name": "Infernal Legions",
        "description": "Demonic armies from the Abyss - hellfire artillery, soul-bound war machines, and daemonic pacts",
        "stat_weights": {"exosphere": 0.25, "naval": 0.15, "military": 0.6},
        "preferred_main_actions": ["attack"],
        "preferred_minor_actions": ["prepare_attack", "sabotage"],
        "aggression": 0.9,
    },
    ...
    # === PSIONIC DOCTRINES ===
    "psionic_covenant": {
        "name": "Psionic Covenant",
        "description": "Telepathic coordination and telekinetic warfare with mind-blade infantry",
        "stat_weights": {"exosphere": 0.3, "naval": 0.2, "military": 0.5},
        "preferred_main_actions": ["attack", "super_unit"],
        "preferred_minor_actions": ["prepare_super_unit", "sabotage"],
        "aggression": 0.65,
    },
    "thought_collective": {
        "name": "Thought Collective",
        "description": "Unified psychic gestalt with perfect tactical coordination",
        "stat_weights": {"exosphere": 0.35, "naval": 0.25, "military": 0.4},
        "preferred_main_actions": ["attack", "defend"],
        "preferred_minor_actions": ["prepare_attack", "fortify_defense"],
        "aggression": 0.6,
    },
    "psychic_ascendancy": {
        "name": "Psychic Ascendancy",
        "description": "Reality-warpers who manipulate probability and battlefield conditions",
        "stat_weights": {"exosphere": 0.4, "naval": 0.3, "military": 0.3},
        "preferred_main_actions": ["super_unit", "attack"],
        "preferred_minor_actions": ["prepare_super_unit", "sabotage"],
        "aggression": 0.55,
    },
